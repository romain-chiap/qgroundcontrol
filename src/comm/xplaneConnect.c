...
{
    return aopenUDP(xpIP, 49009, 0); // Default receive UDP Port in XPlane 49009
}

XPCSocket _aopenUDP(const char *xpIP, unsigned short xpPort, unsigned short port) 
{
	return aopenUDP(xpIP, xpPort, port);
}
