...
TrajectoryPointsAhead::TrajectoryPointsAhead(Vehicle* vehicle, QObject* parent)
    : QObject       (parent)
    , _vehicle      (vehicle)
    , _lastAzimuth  (qQNaN())
{
...
void TrajectoryPointsAhead::_vehicleCoordinateChanged(QGeoCoordinate coordinate)
{
